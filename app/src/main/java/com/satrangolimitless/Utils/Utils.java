...
public class Utils {
	...
	public static Typeface getBold(Context c) {
		try {
			return Typeface.createFromAsset(c.getAssets(), "GoogleSans-Bold.ttf");
		} catch (Exception e) {
			e.printStackTrace();
		}
	...
	public static Typeface getBoldItalic(Context c) {
		try {
			return Typeface.createFromAsset(c.getAssets(), "GoogleSans-BoldItalic.ttf.ttf");
		} catch (Exception e) {
			e.printStackTrace();
		}
		...
		public static Typeface getItalic(Context c) {
			try {
				return Typeface.createFromAsset(c.getAssets(), "GoogleSans-Italic.ttf");
			} catch (Exception e) {
				e.printStackTrace();
			}
	...
	public static Typeface getNormal(Context c) {
		try {
			return Typeface.createFromAsset(c.getAssets(), "GoogleSans-Regular.ttf");
		} catch (Exception e) {
			e.printStackTrace();
		}
