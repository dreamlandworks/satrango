...
public class User_job_bids_list {
   ...
   String v_image,v_name,submission_type,attachment,estimated_time,proposal,bid_amount,vendor_id,job_id,id,job_points,total,usersconn,rating,status;
    ...
    public User_job_bids_list(String id, String job_id, String vendor_id ,String bid_amount,String proposal, String  estimated_time, String attachment, String submission_type,String  v_name, String v_image,String job_points,String total,String usersconn,String rating,String status) {
