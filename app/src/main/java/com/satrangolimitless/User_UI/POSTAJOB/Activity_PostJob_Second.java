...
import com.satrangolimitless.Activity_login_type;
import com.satrangolimitless.LandingActivity;
import com.satrangolimitless.R;
import com.satrangolimitless.session.Session;
import com.satrangolimitless.session.Session_vendor;

public class Activity_PostJob_Second extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.user_jobpost_singlemove_second);
        ...
        btnnextt.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
              ...
              if(bid_per.isEmpty()){
                  Toast.makeText(Activity_PostJob_Second.this, "Please select bid per", Toast.LENGTH_SHORT).show();
              }
               else if(bid_max_range.isEmpty()){
                  Toast.makeText(Activity_PostJob_Second.this, "Please max range", Toast.LENGTH_SHORT).show();

              }
              else if(bid_min_range.isEmpty()){
                  Toast.makeText(Activity_PostJob_Second.this, "Please min range", Toast.LENGTH_SHORT).show();

              }
              else if(accept_bid_for.isEmpty()){
                  Toast.makeText(Activity_PostJob_Second.this, "Please enter accept bid for", Toast.LENGTH_SHORT).show();

              }
               else if(Estimatedtime.isEmpty()){
                  Toast.makeText(Activity_PostJob_Second.this, "Please enter estimated time", Toast.LENGTH_SHORT).show();

              }else{
                  Intent intent = new Intent(Activity_PostJob_Second.this, Activity_PostJob_Third.class);
