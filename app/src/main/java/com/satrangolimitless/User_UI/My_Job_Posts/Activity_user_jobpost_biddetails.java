...
public class Activity_user_jobpost_biddetails extends AppCompatActivity {
    Session session;
    TextView txttime ,txtproposal, txtmembersince, txtjobs, txtskills, txtestimattime, txtname, txtrank,txtrating,txtbidamount;
    String bid_amount, rating,name, proposal, esttime, id, jobid,vendrid , attachment,v_image,job_points,usersconn,total;
    Button btnaward,btnreject;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.user_proposal_details);
    ...
    private void AwardBidapi() {
        final ProgressDialog progressDialog = new ProgressDialog(Activity_user_jobpost_biddetails.this);
...
//                                System.out.println("profile======    " + jsonObject1.toString());
                                ...
                                Toast.makeText(Activity_user_jobpost_biddetails.this, msg, Toast.LENGTH_SHORT).show();
                ...
                new Response.ErrorListener() {
                    ...
                    public void onErrorResponse(VolleyError error) {
                        Toast.makeText(Activity_user_jobpost_biddetails.this, error.toString(), Toast.LENGTH_LONG).show();
                    }
                }) {
            @Override
...
System.out.println("award api params----   "+session.getUserId()+"  "+id+"  "+jobid);
        ...
        rQueue = Volley.newRequestQueue(Activity_user_jobpost_biddetails.this);
