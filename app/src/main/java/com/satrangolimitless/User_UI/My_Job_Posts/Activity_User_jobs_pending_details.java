...
public class Activity_User_jobs_pending_details extends AppCompatActivity {
Session session;
...
LinearLayout ll_discussion, ll_bids;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        FragmentJobBids fdr = new FragmentJobBids();
...
//            txttime.setText(esttime);
            ...
            if (avgrange != null && !avgrange.isEmpty() && !avgrange.equals("null") && !avgrange.equals("0")) {
...
//        User_PendingjobsApi();
    ...
    private void User_PendingjobsApi() {
        final ProgressDialog progressDialog = new ProgressDialog(Activity_User_jobs_pending_details.this);
                ...
                .getAsJSONObject(new JSONObjectRequestListener() {
                    ...
                    public void onResponse(JSONObject jsonObject) {
                        ...
                        try {
                            ...
                            adapter_user_pending_jobs = new Adapter_User_Pending_Jobs(user_pendingJobs_models, Activity_User_jobs_pending_details.this);
                            RecyclerView.LayoutManager mLayoutManger = new LinearLayoutManager(Activity_User_jobs_pending_details.this);
                            RvHistory.setLayoutManager(mLayoutManger);
                            RvHistory.setLayoutManager(new LinearLayoutManager(Activity_User_jobs_pending_details.this, RecyclerView.VERTICAL, false));
