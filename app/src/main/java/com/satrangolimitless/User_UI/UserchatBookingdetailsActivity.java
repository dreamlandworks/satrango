...
public class UserchatBookingdetailsActivity extends AppCompatActivity {
    ...
    String filename;
    Session session;
    String vendorid, bookinid, user_id, message;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (getIntent() != null) {
            ...
            bookinid = getIntent().getStringExtra("id");
        }
        System.out.println("userid <>>><><><     " + user_id  + vendorid);
...
//        getChatList(user_id,job_id);
    ...
    public void onRequestPermissionsResult(int requestCode, @NonNull String[] permissions, @NonNull int[] grantResults) {
        ...
        if (requestCode == STORAGE_PERMISSION_CODE) {
            ...
            if (grantResults.length > 0 && grantResults[0] == PackageManager.PERMISSION_GRANTED) {
                //Displaying a toast
                Toast.makeText(UserchatBookingdetailsActivity.this, "Permission granted now you can read the storage", Toast.LENGTH_LONG).show();
            } else {
                //Displaying another toast if permission is not granted
                Toast.makeText(UserchatBookingdetailsActivity.this, "Oops you just denied the permission", Toast.LENGTH_LONG).show();
            }
        }
    }
    ...
    public void onActivityResult(int requestCode, int resultCode, Intent resultData) {
        ...
        if (requestCode == PICK_PDF_REQUEST && resultCode == RESULT_OK && resultData != null && resultData.getData() != null) {
            ...
            String Fpath = FileUtils.getPath(UserchatBookingdetailsActivity.this, UploadPdfUri);
            file = new File(Fpath);
...
//            et_attachfile.setText(filename);
    ...
    private void requestStoragePermission() {
        if (ContextCompat.checkSelfPermission(UserchatBookingdetailsActivity.this, Manifest.permission.READ_EXTERNAL_STORAGE) == PackageManager.PERMISSION_GRANTED)
            return;
        if (ActivityCompat.shouldShowRequestPermissionRationale(UserchatBookingdetailsActivity.this, Manifest.permission.READ_EXTERNAL_STORAGE)) {

        }

        ActivityCompat.requestPermissions(UserchatBookingdetailsActivity.this, new String[]{Manifest.permission.READ_EXTERNAL_STORAGE}, STORAGE_PERMISSION_CODE);
    }
...
//                    proimg1.setImageBitmap(r.getBitmap());
                    ...
                    file = bitmapToFile(UserchatBookingdetailsActivity.this, r.getBitmap());
                    Log.e("file", "" + file);
                    ...
                    Toast.makeText(UserchatBookingdetailsActivity.this, r.getError().getMessage(), Toast.LENGTH_LONG).show();
                }
            }

        }).show(UserchatBookingdetailsActivity.this);
    }
...
//        sendseendstatus(Groupid, userid);
        ...
        StringRequest stringRequest = new StringRequest(Request.Method.POST, BaseUrl + "user_discuss_booking_with_vendor",
                    ...
                    public void onResponse(String response) {
                        ...
                        try {
                            ...
                            for (int i = 0; i < jsonArray.length(); i++) {
                                ...
                                String job_id = jsonObject.getString("booking_id");
                            ...
                            usersideChatAdapter = new UsersideChat_Adapter(chatmessagelist, UserchatBookingdetailsActivity.this);
                ...
                new Response.ErrorListener() {
                    ...
                    public void onErrorResponse(VolleyError error) {
                        ...
                        Toast.makeText(UserchatBookingdetailsActivity.this, error.getMessage(), Toast.LENGTH_SHORT).show();
                    }
                }) {
            @Override
            protected Map<String, String> getParams() throws AuthFailureError {
                ...
                params.put("booking_id",   bookinid );
    ...
    public void sendmessagefile() {
        ...
        final ProgressDialog progressDialog = new ProgressDialog(UserchatBookingdetailsActivity.this);
        progressDialog.setTitle("Please Wait..");
        progressDialog.show();


        AndroidNetworking.upload(BaseUrl + "user_discuss_booking_with_vendor")
                .addMultipartParameter("booking_id",bookinid)
    ...
    public void GetAolMesageFromGroup() {
      /*  final ProgressDialog progressDialog = new ProgressDialog(UserchatdetailsActivity.this);
        ...
        StringRequest stringRequest = new StringRequest(Request.Method.POST, BaseUrl + "user_get_booking_chat",
                new Response.Listener<String>() {
                    @Override
                    public void onResponse(String response) {
                        try {
                            ...
                            if (result.equals("true")) {
                                ...
                                Log.e("else----  ", msg );
//                                Toast.makeText(UserchatBookingdetailsActivity.this, msg, Toast.LENGTH_SHORT).show();
                            }
                        } catch (JSONException e) {
                            e.printStackTrace();
                        }
