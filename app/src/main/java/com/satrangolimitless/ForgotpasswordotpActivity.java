...
import static com.satrangolimitless.Utils.Base_Url.verify_otp_forget_password_Api;
...
public class ForgotpasswordotpActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_forgotpasswordotp);
        ...
        edt_one.addTextChangedListener(new ForgotpasswordotpActivity.PinTextWatcher(0));
        edt_two.addTextChangedListener(new ForgotpasswordotpActivity.PinTextWatcher(1));
        edt_three.addTextChangedListener(new ForgotpasswordotpActivity.PinTextWatcher(2));
        edt_four.addTextChangedListener(new ForgotpasswordotpActivity.PinTextWatcher(3));

        edt_one.setOnKeyListener(new ForgotpasswordotpActivity.PinOnKeyListener(0));
        edt_two.setOnKeyListener(new ForgotpasswordotpActivity.PinOnKeyListener(1));
        edt_three.setOnKeyListener(new ForgotpasswordotpActivity.PinOnKeyListener(2));
        edt_four.setOnKeyListener(new ForgotpasswordotpActivity.PinOnKeyListener(3));
            ...
            if (edt_two.getText().toString().length() == 1) {
                if (edt_three.getText().toString().length() == 1) {
                    if (edt_four.getText().toString().length() == 1) {
                        ...
                        String url = BaseUrl + verify_otp_forget_password_Api;
    ...
    private void OTPVerifyApi(String url, final String otp, final String id) {
        final ProgressDialog progressDialog = new ProgressDialog(ForgotpasswordotpActivity.this);
        ...
        StringRequest stringRequest = new StringRequest(Request.Method.POST, url,
                new Response.Listener<String>() {
                    ...
                    public void onResponse(String response) {
                        ...
                        System.out.println("forget pasd otp response ===== "+response.toString());
                        try {
                            ...
                            if (result.equalsIgnoreCase("true")) {
                                ...
                                Intent intent = new Intent(ForgotpasswordotpActivity.this, Activity_reset_password.class);
            ...
            protected Map<String, String> getParams() throws AuthFailureError {
                ...
                params.put("otp", otp);
                System.out.println("forget pass otp==========        "+params);
