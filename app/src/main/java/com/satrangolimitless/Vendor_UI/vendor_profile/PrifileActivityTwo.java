...
EditText edt_per_hr,edt_extra_charge,edt_min_charge,edt_per_day;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btn_next.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                final String per_hr = edt_per_hr.getText().toString();
                final String extra_charge = edt_extra_charge.getText().toString();
                final String min_charge = edt_min_charge.getText().toString();
                final String per_day = edt_per_day.getText().toString();
                if (per_hr.isEmpty()) {
                ...
                session_vendor.setAddprday(per_day);
                session_vendor.setAddprhr(per_hr);
                session_vendor.setAddmincharge(min_charge);
                session_vendor.setAddextracharge(extra_charge);
    ...
    private void addView() {
        ...
        txt_from.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                timepickerdialog = new TimePickerDialog(PrifileActivityTwo.this,
                        new TimePickerDialog.OnTimeSetListener() {
                            ...
                            public void onTimeSet(TimePicker view, int hourOfDay,
                                ...
                                txt_from.setText(hourOfDay + ":" + minute + format);
                            }
                ...
                timepickerdialog = new TimePickerDialog(PrifileActivityTwo.this,
                        new TimePickerDialog.OnTimeSetListener() {
                            ...
                            public void onTimeSet(TimePicker view, int hourOfDay,
                                ...
                                txt_to.setText(hourOfDay + ":" + minute + format);
                            }
                        }, CalendarHour, CalendarMinute, false);
                timepickerdialog.show();
    ...
    private void AddtarriffApi() {
        final ProgressDialog progressDialog = new ProgressDialog(PrifileActivityTwo.this);
