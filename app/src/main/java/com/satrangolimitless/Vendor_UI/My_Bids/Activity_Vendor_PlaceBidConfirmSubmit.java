...
public class Activity_Vendor_PlaceBidConfirmSubmit extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.vendor_placebidsecond);
    ...
    public void PlaceBidapi(String user_id, String job_id, String bid_amount, String proposal, String estimated_time, String submission_type) {
        final ProgressDialog progressDialog = new ProgressDialog(Activity_Vendor_PlaceBidConfirmSubmit.this);
        progressDialog.show();
        ...
        Call<Place_Bid> call = apiInterface.PLACE_BID(VENDOR_ID, JOB_ID, BID_AMOUNT, PROPOSAL, ESTIMATE_TIME, SUBMISSION_TYPE, surveyImagesParts);


        call.enqueue(new Callback<Place_Bid>() {
            @Override
            public void onResponse(Call<Place_Bid> call, retrofit2.Response<Place_Bid> response) {
                progressDialog.dismiss();

                System.out.println("RESULT---- BID PLACED         " + response.body().getResult());
                if (response.body().getResult().equals("true")) {

                    DialogueSuccess();
                } else {
                    Toast.makeText(Activity_Vendor_PlaceBidConfirmSubmit.this, response.body().getMsg(), Toast.LENGTH_SHORT).show();
                }
            }

            @Override
            public void onFailure(Call<Place_Bid> call, Throwable t) {
                progressDialog.dismiss();
                Log.e("ccheckResponce", " :" + t.getMessage());
                Toast.makeText(Activity_Vendor_PlaceBidConfirmSubmit.this, t.getMessage(), Toast.LENGTH_LONG).show();
            }
        });
    }
    ...
    public void DialogueSuccess() {
        ...
        final android.app.AlertDialog.Builder builder = new android.app.AlertDialog.Builder(Activity_Vendor_PlaceBidConfirmSubmit.this);
        View view = LayoutInflater.from(Activity_Vendor_PlaceBidConfirmSubmit.this).inflate(R.layout.dialog_bid_successfull_submitted, null);
    ...
    private void selectImage() {
        ...
        android.app.AlertDialog.Builder builder = new android.app.AlertDialog.Builder(Activity_Vendor_PlaceBidConfirmSubmit.this);
        builder.setTitle("Add Photo!");
        builder.setItems(items, new DialogInterface.OnClickListener() {
            @Override
            public void onClick(DialogInterface dialog, int item) {
                boolean result = Utility.checkPermission(Activity_Vendor_PlaceBidConfirmSubmit.this);
    ...
    private void onSelectFromGalleryResult(Intent data) {
        ...
        if (data != null) {
            ...
            Cursor cursor = Activity_Vendor_PlaceBidConfirmSubmit.this.getContentResolver().query(pickedImage, filePath, null, null, null);
            cursor.moveToFirst();
            ...
            if (destination != null) {
                ...
                Toast.makeText(Activity_Vendor_PlaceBidConfirmSubmit.this, "something wrong", Toast.LENGTH_SHORT).show();
            }

            try {
                bm = MediaStore.Images.Media.getBitmap(Activity_Vendor_PlaceBidConfirmSubmit.this.getContentResolver(), data.getData());
            ...
            for (int i = 0; i < grantResults.length; i++) {
                ...
                if (grantResults[i] == PackageManager.PERMISSION_DENIED) {
                    ...
                    if (!showRationale) {
                        ...
                        if (openDialogOnce) {
                            Toast.makeText(Activity_Vendor_PlaceBidConfirmSubmit.this, "Permission required", Toast.LENGTH_SHORT).show();
                            // alertView();
                        }
                    }
                }
