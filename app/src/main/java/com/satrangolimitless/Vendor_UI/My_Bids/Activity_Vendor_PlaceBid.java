...
public class Activity_Vendor_PlaceBid extends AppCompatActivity {
    ...
    String finaldate;
//    Add Attachment
    String vendrdesc, newestimatetime, bidamount, submission_type;
    ImageView img_add;
        ...
        btnsubmit.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                vendrdesc = edtvendorproposal.getText().toString();
                 String estimday=newestimatetime+" "+hourdaysvalue;
                Intent intent = new Intent(Activity_Vendor_PlaceBid.this, Activity_Vendor_PlaceBidConfirmSubmit.class);
                ...
                intent.putExtra("newestimatetime", estimday);
