...
public class VendorchatBookingdetailsActivity extends AppCompatActivity {
...
if (file!=null){
    ...
    public void onRequestPermissionsResult(int requestCode, @NonNull String[] permissions, @NonNull int[] grantResults) {
        ...
        if (requestCode == STORAGE_PERMISSION_CODE) {
            ...
            if (grantResults.length > 0 && grantResults[0] == PackageManager.PERMISSION_GRANTED) {
                //Displaying a toast
                Toast.makeText(VendorchatBookingdetailsActivity.this, "Permission granted now you can read the storage", Toast.LENGTH_LONG).show();

            } else {
                //Displaying another toast if permission is not granted
                Toast.makeText(VendorchatBookingdetailsActivity.this, "Oops you just denied the permission", Toast.LENGTH_LONG).show();
            }
        }
    }
    ...
    public void onActivityResult(int requestCode, int resultCode, Intent resultData) {
        ...
        if (requestCode == PICK_PDF_REQUEST && resultCode == RESULT_OK && resultData != null && resultData.getData() != null) {
            ...
            String Fpath = FileUtils.getPath(VendorchatBookingdetailsActivity.this, UploadPdfUri);
            file = new File(Fpath);
...
//            et_attachfile.setText(filename);
    ...
    private void requestStoragePermission() {
        if (ContextCompat.checkSelfPermission(VendorchatBookingdetailsActivity.this, Manifest.permission.READ_EXTERNAL_STORAGE) == PackageManager.PERMISSION_GRANTED)
            return;
        if (ActivityCompat.shouldShowRequestPermissionRationale(VendorchatBookingdetailsActivity.this, Manifest.permission.READ_EXTERNAL_STORAGE)) {

        }

        ActivityCompat.requestPermissions(VendorchatBookingdetailsActivity.this, new String[]{Manifest.permission.READ_EXTERNAL_STORAGE}, STORAGE_PERMISSION_CODE);
    }
...
//                    proimg1.setImageBitmap(r.getBitmap());
                    ...
                    file = bitmapToFile(VendorchatBookingdetailsActivity.this, r.getBitmap());
                    Log.e("file", "" + file);
                    ...
                    Toast.makeText(VendorchatBookingdetailsActivity.this, r.getError().getMessage(), Toast.LENGTH_LONG).show();
                }
            }

        }).show(VendorchatBookingdetailsActivity.this);
    }
    ...
    public void sendmessage(final String message) {
        ...
        StringRequest stringRequest = new StringRequest(Request.Method.POST, BaseUrl + "vendor_discuss_booking_with_user",
                new Response.Listener<String>() {
                    ...
                    public void onResponse(String response) {
                        ...
                        try {
                            ...
                            usersideChatAdapter = new VendorsideChat_Adapter(chatmessagelist, VendorchatBookingdetailsActivity.this);
                ...
                new Response.ErrorListener() {
                    ...
                    public void onErrorResponse(VolleyError error) {
                        ...
                        Toast.makeText(VendorchatBookingdetailsActivity.this, error.getMessage(), Toast.LENGTH_SHORT).show();
                    }
                }) {
            @Override
    ...
    public void sendmessagefile() {
        ...
        final ProgressDialog progressDialog = new ProgressDialog(VendorchatBookingdetailsActivity.this);
        progressDialog.setTitle("Please Wait..");
        progressDialog.show();


        AndroidNetworking.upload(BaseUrl + "vendor_discuss_booking_with_user")
    ...
    public void GetAolMesageFromGroup() {
      /*  final ProgressDialog progressDialog = new ProgressDialog(VendorchatdetailsActivity.this);
        ...
        StringRequest stringRequest = new StringRequest(Request.Method.POST, BaseUrl + "vendor_get_booking_chat",
                new Response.Listener<String>() {
                    @Override
                    public void onResponse(String response) {
                        try {
...
//                                Toast.makeText(VendorchatBookingdetailsActivity.this, msg, Toast.LENGTH_SHORT).show();
                            }
                        } catch (JSONException e) {
                            e.printStackTrace();
                        }
