...
public class VendorsideChat_Adapter extends RecyclerView.Adapter<VendorsideChat_Adapter.ViewHolder> {
    Context mContext;
    ...
    public VendorsideChat_Adapter(List<UserChatmodel> chatList, Context context) {
    ...
    public ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View itemView = LayoutInflater.from(parent.getContext()).inflate(R.layout.vendorgroupchatlayout, parent, false);
...
*/
        ...
        try {
            VendorsideChat_Adapter.this.notify();
