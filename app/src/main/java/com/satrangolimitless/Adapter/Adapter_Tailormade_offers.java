...
public class Adapter_Tailormade_offers extends RecyclerView.Adapter<Adapter_Tailormade_offers.ViewHolder> {
    Session session1;
    private final List<Tailormadeoffers_model> category_home_models;
    private final Context context;


    public Adapter_Tailormade_offers(ArrayList<Tailormadeoffers_model> category_home_models, Context context) {
