...
public class ChatAdapterVendor extends RecyclerView.Adapter< ChatAdapterVendor.MyViewHolder> {

    Context context ;
    ArrayList<ChatModel> chatModels;

    public ChatAdapterVendor(Context context, ArrayList<ChatModel> chatModels) {
