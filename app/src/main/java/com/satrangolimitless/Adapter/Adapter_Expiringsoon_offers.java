...
public class Adapter_Expiringsoon_offers extends RecyclerView.Adapter<Adapter_Expiringsoon_offers.ViewHolder> {
    Session session1;
    private final List<Offers_expiringsoon_model> category_home_models;
    private final Context context;


    public Adapter_Expiringsoon_offers(ArrayList<Offers_expiringsoon_model> category_home_models, Context context) {
