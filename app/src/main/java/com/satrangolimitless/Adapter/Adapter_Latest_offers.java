...
public class Adapter_Latest_offers extends RecyclerView.Adapter<Adapter_Latest_offers.ViewHolder> {
    private final List<Latest_offers_model> category_home_models;
    private final Context context;
    Session session1;


    public Adapter_Latest_offers(ArrayList<Latest_offers_model> category_home_models, Context context) {
