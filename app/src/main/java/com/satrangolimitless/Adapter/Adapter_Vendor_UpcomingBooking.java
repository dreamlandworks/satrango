...
public class Adapter_Vendor_UpcomingBooking extends RecyclerView.Adapter<Adapter_Vendor_UpcomingBooking.ViewHolder> {
    ...
    String e1 = "", e2 = "", e3 = "", e4 = "", otp = "",finalString;
    String vid, bookingid;
    private EditText[] editTexts;

    public Adapter_Vendor_UpcomingBooking(List<Vendor_UpcomingBooking> category_home_models,List<Confirm_Bid> confirm_bids, Context context) {
...
*/
        ...
        Glide.with(context)
                .load(mediimage_url+allCommunityModel.getUser_image()).into(holder.imageprofile);
        ...
        holder.ll_details.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                intent.putExtra("userimage", category_home_models.get(position).getUser_image());
                intent.putExtra("attach", category_home_models.get(position).getUpload_doc());
                intent.putExtra("desc", category_home_models.get(position).getWork_description());

             System.out.println("adapter getUpload_doc--------     "+category_home_models.get(position).getUpload_doc());
        ...
        holder.txtstart.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                intent.putExtra("image", category_home_models.get(position).getUser_image());
                intent.putExtra("vdoc", category_home_models.get(position).getVendor_doc());
                intent.putExtra("votp", category_home_models.get(position).getVerify_otp());
                intent.putExtra("jobstts", category_home_models.get(position).getJob_status());
...
//Api for OTP MATCH BY VENDOR
    ...
    public class ViewHolder extends RecyclerView.ViewHolder {
        ...
        ImageView img_call, imgchat, fav2;
